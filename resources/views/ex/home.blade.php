            ...
            <h6 class="mt-3">
                ...
                atau <a href="{{ route('auth.register') }}" style="text-decoration: none">daftar</a>
                 jika anda belum punya akun
                  ...
                  <a style="text-decoration: none;" href="{{route('ex.beritaKSI')}}">Berita KSI</a> |
                    <a style="text-decoration: none;" href="{{route('ex.profileKelulusanKSI')}}">Profile Kelulusan</a> |
                    <a style="text-decoration: none;" href="{{route('ex.profileDosen')}}">Profile Dosen </a>
          </div>
        </div>     
      </div>
