        ...
        <div class="col-12 text-center">
            ...
            <h6 class="mt-3">
                ...
                <a style="text-decoration: none;" href="{{route('ex.beritaKSI')}}">Berita KSI</a> |
                  <a style="text-decoration: none;" href="{{route('ex.profileKelulusanKSI')}}">Profil Kelulusan</a> |
                  <a style="text-decoration: none;" href="{{route('ex.profileDosen')}}">Profil Dosen </a>
          </div>
        </div>     
      </div>
